...
# Experiment 5: Malware Analysis (Detailed)

## Aim
To perform experiment 5 as part of malware analysis using Ubuntu tools in a controlled environment.

## Objective
- Understand the concept behind experiment 5
...
This experiment focuses on concept 5 including static/dynamic/reverse/network analysis depending on the case.
...
## Result
Experiment 5 completed successfully. Malware behavior and characteristics were analyzed.
