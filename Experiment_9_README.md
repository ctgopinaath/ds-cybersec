...
# Experiment 9: Malware Analysis (Detailed)

## Aim
To perform experiment 9 as part of malware analysis using Ubuntu tools in a controlled environment.

## Objective
- Understand the concept behind experiment 9
...
This experiment focuses on concept 9 including static/dynamic/reverse/network analysis depending on the case.
...
## Result
Experiment 9 completed successfully. Malware behavior and characteristics were analyzed.
