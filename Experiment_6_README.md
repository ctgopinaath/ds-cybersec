...
# Experiment 6: Malware Analysis (Detailed)

## Aim
To perform experiment 6 as part of malware analysis using Ubuntu tools in a controlled environment.

## Objective
- Understand the concept behind experiment 6
...
This experiment focuses on concept 6 including static/dynamic/reverse/network analysis depending on the case.
...
## Result
Experiment 6 completed successfully. Malware behavior and characteristics were analyzed.
