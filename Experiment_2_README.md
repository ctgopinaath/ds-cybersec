...
# Experiment 2: Malware Analysis (Detailed)

## Aim
To perform experiment 2 as part of malware analysis using Ubuntu tools in a controlled environment.

## Objective
- Understand the concept behind experiment 2
...
This experiment focuses on concept 2 including static/dynamic/reverse/network analysis depending on the case.
...
## Result
Experiment 2 completed successfully. Malware behavior and characteristics were analyzed.
