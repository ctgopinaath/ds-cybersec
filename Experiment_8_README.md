...
# Experiment 8: Malware Analysis (Detailed)

## Aim
To perform experiment 8 as part of malware analysis using Ubuntu tools in a controlled environment.

## Objective
- Understand the concept behind experiment 8
...
This experiment focuses on concept 8 including static/dynamic/reverse/network analysis depending on the case.
...
## Result
Experiment 8 completed successfully. Malware behavior and characteristics were analyzed.
