...
# Experiment 3: Malware Analysis (Detailed)

## Aim
To perform experiment 3 as part of malware analysis using Ubuntu tools in a controlled environment.

## Objective
- Understand the concept behind experiment 3
...
This experiment focuses on concept 3 including static/dynamic/reverse/network analysis depending on the case.
...
## Result
Experiment 3 completed successfully. Malware behavior and characteristics were analyzed.
