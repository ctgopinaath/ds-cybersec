...
# Experiment 4: Malware Analysis (Detailed)

## Aim
To perform experiment 4 as part of malware analysis using Ubuntu tools in a controlled environment.

## Objective
- Understand the concept behind experiment 4
...
This experiment focuses on concept 4 including static/dynamic/reverse/network analysis depending on the case.
...
## Result
Experiment 4 completed successfully. Malware behavior and characteristics were analyzed.
